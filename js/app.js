...
console.log({imageContainer,resultButton,image1,image2});
...
function getRandomNumber(){
    return Math.round(Math.random() * Animals.allAnimalsArray.length);
}

function renderAnimals(){
    let animal1 = getRandomNumber();
    let animal2 = getRandomNumber();
    let animal3 = getRandomNumber();
    console.log(animal1,animal2,animal3);

    while(animal1 === animal2 === animal3) {
...
image1.alt = Animals.allAnimalsArray[animal1];
image2.alt = Animals.allAnimalsArray[animal2];
image3.alt = Animals.allAnimalsArray[animal3]
